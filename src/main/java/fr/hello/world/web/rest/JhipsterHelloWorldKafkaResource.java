...
@RestController
@RequestMapping("/api/jhipster-hello-world-kafka")
public class JhipsterHelloWorldKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterHelloWorldKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterHelloWorldKafkaResource(KafkaProperties kafkaProperties) {
