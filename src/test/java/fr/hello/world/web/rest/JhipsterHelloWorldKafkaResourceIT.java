...
import fr.hello.world.config.KafkaProperties;
...
class JhipsterHelloWorldKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterHelloWorldKafkaResource kafkaResource = new JhipsterHelloWorldKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-hello-world-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-hello-world-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
